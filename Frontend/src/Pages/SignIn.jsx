...
function SignIn() {
    ...
    return (
        <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})`,}}>
            ...
            <button className='min-w-[150px] h-[60px] bg-blue-500 text-white rounded-full text-[18px] font-semibold hover:bg-blue-600 transition-all duration-300 cursor-pointer mt-[10px]'disabled={loading}>
                {loading ? "Loading..." : "Sign In" }
            </button >
            <p className='text-[white] text-[18px]'>Don't have an account?
